...
#enable SSO when configured by env vars
GITHUB_APP_ID = os.environ.get('SENTRY_GITHUB_APP_ID') or ''
GITHUB_API_SECRET = os.environ.get('SENTRY_GITHUB_API_SECRET') or ''
